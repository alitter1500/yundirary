...
public class NoteDao {
     ...
     * @return
     */
    public int addOrUpdate(TbNote note) {
        //定义sql语句
        String sql="";
     ...
     * @return
     */
    public List<TbNote> findNoteListByPage(Integer userId, Integer index, Integer pageSize,String title,String date,String typeId) {
        //定义sql语句
        ...
        //调用BaseDao的查询方法
        List<TbNote> noteList=BaseDao.queryRows(sql,params, TbNote.class);
    ...
    public TbNote findNoteById(String noteId) {
        ...
        // 调用BaseDao的查询方法
        TbNote note= (TbNote) BaseDao.queryRow(sql,params, TbNote.class);
     ...
     * @return
     */
    public List<TbNote> queryNoteList(Integer userId) {
        // 定义SQL语句
        ...
        param.add(userId);
        // 调用BaseDao
        List<TbNote> list=BaseDao.queryRows(sql,param, TbNote.class);
