...
//        5. 如果密码正确
     ...
     * @return
     */
    public Integer checkNick(String nick, long userId) {
        //1. 判断昵称是否为空
    ...
    //2. 参数的非空校验（判断必填参数非空）
        ...
        try {
            ...
            //2. 通过Part对象获取上传文件的文件名(从头部信息获取的用户名)
            String head=part.getHeader("Content-Disposition");
            //获取具体的请求头对应的值
            String str=head.substring(head.lastIndexOf("=")+2);
            //获取上传的文件名
