...
import com.note01.dao.NoteTypeDao;
...
public class NoteTypeService {
     ...
     *  2. 返回类型集合
     */
    public List<TbNoteType> findTypeList(Integer userId){
        List<TbNoteType> typeList=typeDao.findTypeListByUserId(userId);
        return typeList;
    }
     ...
     * @return
     */
    public ResultInfo<TbNoteType> deleteType(String typeId) {
        ResultInfo<TbNoteType> resultInfo=new ResultInfo<>();
        // 1. 判断参数是否为空
